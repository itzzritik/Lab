		...
		<div className="mx-auto max-w-4xl p-8">
			...
			<section className="mb-6 animate-fade-up rounded-2xl border border-base-content/15 bg-base-100 p-6">
				...
				<button
					...
					className="flex w-full items-center justify-center gap-2 rounded-lg py-2.5 text-sm text-base-content/60 transition-all dur-fast hover:bg-base-content/5 hover:text-base-content/80">
				...
				<div className={cn("grid transition-all dur-slow", themesExpanded ? "grid-rows-[1fr]" : "grid-rows-[0fr]")}>
					<div className="overflow-hidden">
						<p className="mb-2.5 mt-3 text-[0.6rem] font-semibold uppercase tracking-[0.15em] text-base-content/50">Light</p>
						...
						<p className="mb-2.5 text-[0.6rem] font-semibold uppercase tracking-[0.15em] text-base-content/50">Dark</p>
						...
						<button
							...
							className={cn(
								...
								speed === s.id
									...
									: "border-base-content/15 bg-base-200 hover:border-base-content/25 hover:bg-base-300",
							)}>
							<div
								className={cn(
									"flex h-10 w-10 items-center justify-center rounded-full transition-colors dur",
									speed === s.id ? "bg-primary/15 text-primary" : "bg-base-300 text-base-content/60",
								)}>
							...
							<span className={cn("text-center text-[0.65rem]", speed === s.id ? "text-primary/70" : "text-base-content/60")}>{s.description}</span>
						</button>
					))}
				</div>
			</section>
