			...
			<div className="grid grid-cols-1 gap-6 lg:grid-cols-12 lg:grid-rows-[minmax(300px,auto)_auto]">
				...
				<section
					...
					<div className="relative flex flex-col justify-between gap-6 border-b border-base-content/5 p-6 lg:flex-row lg:items-center">
						...
						<div className="relative flex w-full max-w-[324px] rounded-full p-1.5 backdrop-blur-3xl mx-auto lg:mx-0 shadow-[inset_0_1px_1px_rgba(255,255,255,0.05),0_4px_24px_rgba(0,0,0,0.1)] ring-1 ring-white/5 bg-base-content/[0.03]">
							<div
